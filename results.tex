...
Closure 2 is the one that changes how the two-dimensional screen should
be read. The unrodded axial factor on the core with hardware agrees
with the water-slab value of Section~\ref{sec:meth-lax} to within
\SI{211}{pcm}, but the rodded factors are smaller, \num{1.0219} to
\num{1.0252} with two banks and \num{1.0126} to \num{1.0177} with four.
A smaller factor means less axial leakage credit, so the rodded
three-dimensional core is more subcritical than the two-dimensional
screen assumed.

Closure 4 measures that conservatism directly. Against the benchmark
rod on the three-dimensional core, the two-dimensional screen with
full-height boron carbide is conservative by \num{1272} to
\SI{2047}{pcm} on four banks and by \num{2062} to \SI{2671}{pcm} on two
banks. The screen therefore rejected designs it did not need to reject,
and no design was admitted that the hardware would refuse.
