...
%% ---------------------------------------------------------------------------
%% Campaign 5: high-fidelity confirmation of the least-infeasible champion.
%% Insert into results.tex after the Campaign 5 optimisation subsection.
%% Requires: booktabs, amsmath, siunitx not required.
%% ---------------------------------------------------------------------------
...
Section~\openpoint{cross-reference the zoning section once written}.