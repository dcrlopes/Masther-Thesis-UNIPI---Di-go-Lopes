...
\openpoint{Verify which version of the depletion solver was used for
Campaigns 1 to 4. The option controlling the writing of reaction rates was
introduced in version 0.15.3. Campaigns executed with an earlier version
