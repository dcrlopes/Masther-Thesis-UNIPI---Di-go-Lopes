...
\usepackage{subcaption}    % panels (a), (b) inside a single figure
...
\usepackage{lipsum}
\usepackage{silence}           % filter one obsolete sectsty check %AUTHOR Insertion
...
\usepackage[version=4]{mhchem} % for \ce chemical formulae
\makeatletter\def\input@path{{xreview/}}\makeatother %AUTHOR Insertion
\usepackage{xreview} % to allow document review
\authoredcomments[color=cyan, size=\scriptsize]{author}
\authoredcomments[color=orange, size=\scriptsize]{reviewer}
...
%%% A list of LaTeX fonts and information on how to use them   %%%
...
{\Large \textsc{Surrogate-Assisted Multi-Objective Optimisation with OpenMC}}\\[0.3cm]
{\large \textsc{Development and Validation of a Framework for the Neutronic Design of a Compact LEU SMR Core}}\\[1.5cm]
...
To my parents, for their love, their example and their support, and for
the investment in my education that brought me to this point.

To the Brazilian Navy, for entrusting me with the responsibility of
acquiring knowledge in nuclear engineering and for the support that allowed
me to carry out my activities in Italy.

To my supervisors, Prof.~Valerio Giusti and Prof.~Riccardo Ciolini, for
their guidance, patience and support throughout this work.

To the professors of the Master of Science Degree in Nuclear Engineering at
the University of Pisa, for their valuable teaching, which awakened my
interest in nuclear engineering and prepared me to carry out my
professional activity well.

To my family and friends, for their encouragement and help, which, even
when indirect, allowed this study to be completed.
